...
import com.pluralsight.webfunction.entity.TollRecord;
import com.pluralsight.webfunction.entity.TollStation;
...
public class WebFunctionApplication {
	...
	public WebFunctionApplication() {
		// in lieu of service or db transaction
		tollStations = new ArrayList<>();
		tollStations.add(new TollStation("100A", 112.5f, 2));
		tollStations.add(new TollStation("111C", 124f, 2));
	...
	public Function<String, TollStation> retrieveStation() {
		return value -> {
			System.out.println("received request from station : " + value);
